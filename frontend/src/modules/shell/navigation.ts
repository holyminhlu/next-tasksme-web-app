...
export const APP_ROUTES: RouteMeta[] = [
  ...
  },
  {
    ...
    href: "/templates",
    label: "Templates",
    description: "Create projects from versioned workspace templates",
    icon: Library,
    section: "main",
    requiresPermission: "projects:read",
    requiresModule: "projects",
  ...
  },
  {
    ...
    label: "Automation",
    description: "Recurring tasks, risk rules, SLA and job history",
    icon: Timer,
    section: "settings",
    parentId: "settings",
    requiresPermission: "automation.view",
  },
  {
    id: "settings-danger",
